del pat0*.png
make & bin\oppat.exe -r ..\oppat_data\lnx\gb10 --cpu_diagram web\haswell_block_diagram.svg --phase0 "Single-Core AES" --phase1 "Multi-Core Memory Bandwidth" --by_phase --ph_image pat --img_wxh_pxls 1017,1388 --follow_proc geekbench --skip_phases_with_string "idle: " > tmpa.jnk
