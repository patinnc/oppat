...
g++ $MTUNE -std=c++11 -static  -Iinc -O4 -g spin_wait/spin.cpp src/utils.cpp spin_wait/trace_marker.cpp -o bin/spin.x -pthread -Wl,--whole-archive -lpthread -Wl,--no-whole-archive
ls -l bin/spin.x
