...
g++ $MTUNE -std=c++11 $STATIC1 -Iinc -O4 -g spin_wait/spin.cpp $OBJ/mygetopt.$OBJEXT src/utils.cpp src/utils2.cpp spin_wait/trace_marker.cpp -o bin/spin.x -pthread $STATIC2 -lnuma -lpthread $STATIC3
ls -l bin/spin.x
