...
make && bin\oppat.exe -r ..\oppat_data\lnx\multi8 --cpu_diagram web\haswell_block_diagram.svg --ph_image pat --by_phase --phase0 "end phase MT mem RD BW test" --phase1 "end phase MT spin test" --img_wxh_pxls 1017,1388  > tmp.jnk
goto :EOF
