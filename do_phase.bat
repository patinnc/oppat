...
goto :EOF
make && bin\oppat.exe -r ..\oppat_data\lnx\multi7 --cpu_diagram web\haswell_block_diagram.svg --ph_image pat --ph_step_int 0.1 --phase0 "begin phase MT mem RD BW test" --phase1 "end phase MT spin test"  > tmp.jnk
